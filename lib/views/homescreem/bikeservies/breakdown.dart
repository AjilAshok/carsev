    ...
    return SafeArea(
      child: Scaffold(
        body: Column(
          ...
          Text("Your Vehicle breakdown don't worry we help you",style: TextStyle(color: Colors.red,fontSize:15,fontWeight: FontWeight.bold ),overflow:TextOverflow.ellipsis ,),
           SizedBox(
            height: 30,
          ),
          Expanded(
...
class Bikebreakdownform extends StatelessWidget {
   Bikebreakdownform({ Key? key }) : super(key: key);
   final bikesites=[
     "item 1",
    "item 2",
    "item 3",
